...
# Seleccion de especie y caracteristicas (seleccion de columnas)
...
# Habría que cambiar la especie únicamente. Se puede hacer una función, pero teniendo en cuenta las diferencias en
